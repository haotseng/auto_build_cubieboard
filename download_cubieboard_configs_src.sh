#!/bin/bash
#
# Download the configs files for cubieboard  code from internet
#
...
function show_syntax () {
  echo 
  echo "This script will download some configs file for cubieboard from internet."
  echo 
  echo "The syntax:"
...
tools_src_path="https://github.com/cubieboard/cubie_configs"
