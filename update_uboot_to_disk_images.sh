...
function show_syntax () {
  echo 
  echo "This script will update uboot into the pre-build disk images."
...
if [ ! -f ${uboot_dir}/boot.cmd ]; then
    echo "Can't found ${uboot_dir}/boot.cmd"
    exit_process 1
fi

if [ ! -f ${uboot_dir}/boot.scr ]; then
    echo "Can't found ${uboot_dir}/boot.scr"
    exit_process 1
fi

if [ ! -f ${uboot_dir}/script.bin ]; then
    echo "Can't found ${uboot_dir}/script.bin"
    exit_process 1
fi

if [ ! -f ${uboot_dir}/sunxi-spl.bin ]; then
    echo "Can't found ${uboot_dir}/sunxi-spl.bin"
    exit_process 1
fi

if [ ! -f ${uboot_dir}/u-boot.img ]; then
    echo "Can't found ${uboot_dir}/u-boot.img"
    exit_process 1
fi
